const string Program_Name = "Program 1-4:Object Manipulation"; //Name me!
...
/*
 * Assignment 1-4: Create an "IMyDoor" object using GetDoorWithName, and call "OpenDoor" on it.
*/
...
//This method will try to find the door you request. Be sure to spell it right!
IMyDoor GetDoorWithName(string doorname){
	return (IMyDoor)Prog.P.GridTerminalSystem.GetBlockWithName(doorname);
}
...
public Program(){
	...
	Door=(IMyDoor)GridTerminalSystem.GetBlockWithName("Program 1-4 Door");
	PrintStatus();
}
...
void PrintStatus(){
	Write("Door Name:\""+Door.CustomName+"\"");
	Write("Door Status:"+Door.Status.ToString());
}
...
Tutorial MyTutorial;
string Prog_String="Program 1-4";
